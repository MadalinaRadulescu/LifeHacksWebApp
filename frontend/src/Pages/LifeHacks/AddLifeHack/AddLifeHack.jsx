...
const AddLifeHack = () => {
    ...
    function handleCategoryUpload(categoryId) {
        if (lifeHack.categoriesId.includes(categoryId)) {
            const newCategoriesId = lifeHack.categoriesId.filter((categoryId) => categoryId !== 2);
    ...
    >
        ...
        >
            ...
            <button type={"submit"} className={styles.postLifeHackButton}>
                <span>POST</span>
                <span>
