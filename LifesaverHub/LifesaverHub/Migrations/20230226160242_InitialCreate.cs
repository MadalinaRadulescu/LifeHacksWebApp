    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "To easily remove the steam from the strawberries we recommend to use a straw as in image from bellow.", "", "", 27L, "How to remove the steam from the strawberries?", "0", new List<long> { 1L } },
                    { 2, "The best way to kip chips fresh after opening is by using any clipper, like the ones from hanger.", "", "", 0L, "How to properly close a bag of chips?", "0", new List<long> { 1L } },
                    ...
                    { 5, "Sprinkle dried rice under your cupcake cases before baking. The rice absorbs any grease throughout baking meaning you get lovely dry cupcake bases and no greasy patches on your cases!", "", "", 25L, "Useful tip for baking cupcakes", "1", new List<long> { 1L } }
                });
