    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "To easily remove the steam from the strawberries we recommend to use a straw as in image from bellow.", "", "strawberries and the straw", 27L, "How to remove the steam from the strawberries?", 0, new List<long> { 0L } },
                    { 2, "The best way to kip chips fresh after opening is by using any clipper, like the ones from hanger.", "", "chips and hanger", 0L, "How to properly close a bag of chips?", 0, new List<long> { 0L } },
                    { 3, "We’re sure you’re stocking up on sweet smelling candles to make your home extra cozy for the colder months. But, if your candles are burning too low to reach the wick, there’s no reason to go without your favorite scent. Instead of burning your fingers, light a piece of uncooked spaghetti. It’ll reach into those deep candles and burn long enough to light the candles on grandpa’s birthday cake!", "", "", 12L, "Pasta Lighter", 0, new List<long> { 1L } },
                    { 4, "Fastest way to do that is simply putting a hair elastic on a vacuum and slowly suck the hair in.", "https://www.boredpanda.com/blog/wp-content/org_uploads/2013/01/life-hacks-36.gif", "", -43L, "Fastest way to catch the hair in the tail", 1, new List<long> { 3L } },
                    { 5, "Sprinkle dried rice under your cupcake cases before baking. The rice absorbs any grease throughout baking meaning you get lovely dry cupcake bases and no greasy patches on your cases!", "", "cupcakes and rice", 25L, "Useful tip for baking cupcakes", 1, new List<long> { 0L } }
                });
